...
class FetchWorldNewsPostUseCase {
  final PostRepository _postRepository;
  static final LinkedHashSet<NewsPost> _cachedNews = LinkedHashSet();
  NewsPost? _lastFetchedPost;

  FetchWorldNewsPostUseCase({
    required PostRepository postRepository,
  }) : _postRepository = postRepository;

  Future<Result<List<NewsPost>?>> fetchWorldNewsPostsNews({
    ...
    Result<List<NewsPost>> fetchPostResult = await _postRepository.fetchWorldNews(
      pageSize: pageSize,
      country: country,
      keywords: keywords,
    );
